...
/**
 * Helper class used to queue and execute the movement of a set of blocks. See {@link mrtjp.mcframes.TileMotor} for
 * usage.
 */
public abstract class Relocator {

    /**
     * Pushes an instance of the Relocator onto the stack. Must be called before using any methods.
     */
    public abstract void push();

    /**
     * Pops the instance of the Relocator off the stack. Must be called after you are done using this.
     *
    ...
    /**
     * Sets the direction towards which all the queued blocks will move. This is a ForgeDirection index, from 0 to 5
     *
    ...
    /**
     * Sets the speed of the movement. Must be greater than 0 and less than 1.
     *
    ...
    /**
     * Sets a callback object that receives events during the actual move. This is optional and is not required to be
     * set.
     *
    ...
    /**
     * Used to execute the queued movement. Before calling, the world, direction, and queue of blocks must be set.
     *
     * @return True if the movement was successfully started.
     *
     * @throws IllegalStateException If the Relocator is not on the stack.
     * @throws IllegalStateException If any of the required parameters are not set or are invalid.
     */
