...
public abstract class MCFramesAPI {
    ...
    /**
     * Used to register a custom placment that can define how a frame is placed. This is useful for cases such as if the
     * frame is placed on a Multipart from the Forge Multipart API, this placement property can perform special actions
    ...
    /**
     * Used to register a {@link IFrameInteraction}, which is a class that can be used to add frame-like properties to
     * any block.
     *
    ...
    /**
     * Getter for the optional StickResolver object which can be used to quicky resolve a structure based on default
     * Relocation frame blocks and stick rules.
     *
    ...
    /**
     * Getter for the instance variable of the Frame block. Used if external implementations need the block. (i.e.
    ...
    /**
     * Tessellates the frame model at the given coordinates. Useful for making your block look like the default frame
     * block.
     *
    ...
    /**
     * Raytrace a frame block at the given world coords with start and end points of a ray.
     *
     * @param x     The x coordinate.
     * @param y     The y coordinate.
     * @param z     The z coordinate.
